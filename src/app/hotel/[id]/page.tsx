...
export default async function HotelPage({ params }: HotelPageProps) {
  ...
  return (
    <main className="flex-1 pb-24 bg-background text-foreground relative min-h-screen">
      {/* HD Fixed Blurred Parallax Background */}
      <div 
        className="fixed inset-0 w-full h-full z-0 bg-cover bg-center bg-no-repeat pointer-events-none scale-105 opacity-[0.08] dark:opacity-[0.04] blur-[20px]"
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-5xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            {/* Description Block */}
            <div className="bg-card/75 backdrop-blur-md border border-border/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 pt-8 border-t border-border/70">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-primary/10 text-primary rounded-full flex items-center justify-center text-xs font-bold">✓</div>
                  <div>
          ...
          <div className="space-y-6">
            <div className="bg-card/75 backdrop-blur-md border border-border/50 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 space-y-4">
            ...
            <div className="bg-primary/5 backdrop-blur-sm border border-primary/20 p-6 rounded-2xl text-xs space-y-3 shadow-lg">
